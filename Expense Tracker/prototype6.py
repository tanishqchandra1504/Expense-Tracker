...
def main(page:Page):
    ...
    category_input = TextField(hint_text="Enter new category...(max 10 characters)", expand=True, on_submit=lambda _:add_category(),)
...
#                           alignment=alignment.top_right
    ...
    def open_snackbar_addedexpense():
        page.snack_bar=SnackBar(content=Text("Expense Added Successfully!"),duration=2000,
