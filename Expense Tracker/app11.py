...
#drop down for editdata page
    ...
    analysis_dropdown=Dropdown(
        ...
        on_change=lambda _ : change_analysis_format(),color=colors.WHITE
    )   
                                                        ...
                                                        content=(
                                                            Row(
                                                                controls=[
                                                                    ...
                                                                    Text(get_week_dates(database.get_week_no(datetime.datetime.today().strftime("%d %m %Y"))),color=colors.GREEN_600),
                                                                    IconButton(
                                                                        width=30,
                                                                        content=Icon(icons.ARROW_FORWARD_IOS,color=colors.GREEN_600),
...
#                           alignment=alignment.top_right
    ...
    def add_category_row(category, color):
        category_container.controls.append(Container(bgcolor=colors.GREEN_600, border_radius=15, padding=5, content=
            Row(
