...
def main(page:Page):
    ...
    category_input = TextField(hint_text="Enter new category",color=colors.WHITE, expand=True, on_submit=lambda _:add_category())
    ...
    EditData_Contents=Row(                                                        #PARTH CODE FOR EDIT DATA PAGE
        controls=[Container(expand=True,
                           ...
                           content=Column(controls=[
                            ...
                            Divider(color=colors.GREEN_900,height=2),
...
#                           alignment=alignment.top_right
    ...
    def add_category_row(category, color):
        category_container.controls.append(Container(bgcolor=colors.CYAN_900, border_radius=15,height=50, padding=5, content=
            Row(
                ...
                controls=[
                    ...
                    Text(category, color=colors.WHITE, font_family='bold', size=20),
                    Row(
                        controls=[
                            IconButton(
    ...
    def add_editdata_row(category_color,category,amount,date):
            editdata_list.controls.append(
                ...
                controls=[
                    ...
                    Text(amount, color = "white", size=20),
                    Row(
                        controls=[
                            IconButton(
                                content=Icon(icons.EDIT),
    ...
    def show_daily_analysis(date):
        ...
        Analysis_Contents.controls[0].content.controls[3].controls.append(Divider(thickness=3,color=colors.GREEN_600))
...
#####################################################################################################################
    ...
    page.theme=Theme(color_scheme_seed="green600")
